...
export const services = {
  ...
  ): AxiosPromise<{ permission: PermissionSelect }> => permissionsAxios.post('/create', permissionDetails),
  updateOne: async (
    id: PermissionSelect['id'],
    data: Partial<PermissionSelect>
  ): AxiosPromise<{ permission: PermissionSelect }> => permissionsAxios.patch(`/update/${id}`, data),
  deleteOne: async (
    id: PermissionSelect['id']
  ): AxiosPromise<{ permission: PermissionSelect }> => permissionsAxios.delete(`/delete/${id}`)
};
